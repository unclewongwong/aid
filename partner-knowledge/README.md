...
兼容下限以每个版本的 `manifest.json` 和 `channel.json` 为准：2026.09.16.1 及更早版本最低为 0.1.31，2026.09.16.2 至 2026.09.16.6 最低为 0.1.32。需要新增工具或模型适配器的技巧应提高兼容下限；知识文件不能给旧应用增加 MCP 或 API 能力。提示词案例作为参考资料，不拥有修改 Skill 或系统指令的权限。
