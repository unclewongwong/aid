...
import { isComfyUIQwenImage21, isGptImage2Model, isMidjourneyImageModel } from './imageModels';
...
export function imageCreationInputError(input: {
  ...
  if (isComfyUIQwenImage21(input.model) || isMidjourneyImageModel(input.model)) {
