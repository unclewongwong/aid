...
import { assertH3ProductionSupport, companionVersionAtLeast, comfyUIApiUrl, downloadComfyUIVideo, H3_DIRECTOR_COMPANION_MIN_VERSION, isComfyUIClientTask, localComfyUISettings, videoStatusResponseError } from '@/lib/comfyuiClient';
...
export default function ImageToVideoPage() {
  ...
  const handleGenerate = async () => {
    ...
    setIsGenerating(true);
    try {
      if (isComfyUI) await assertH3ProductionSupport(settings.comfyui);
